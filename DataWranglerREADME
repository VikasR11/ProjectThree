Name of DataWrangler: Arnav Karnik
@wisc.edu Email of DataWrangler: akarnik@wisc.edu
Group: JC
Team: Red
...
AirportInterface.java -> interface for methods in airport
Airport.java -> creates the airport object
...
<List any additional contributions that you have made toward your team's
 ...
 Helped others understand my implementation of code
